...
#define TID_VERSION "0.9.0" // July 16, 2022

// choose either FFTW_MEASURE or FFTW_ESTIMATE here.
#define FFTWPLANNERFLAG FFTW_ESTIMATE

#define TID_MINBARKSPACING 0.1
#define TID_MAXBARKSPACING 6.0
#define TID_BARKSPACINGDEFAULT 0.5
#define TID_MINMELSPACING 5.0
#define TID_MAXMELSPACING 1000.0
#define TID_MELSPACINGDEFAULT 100.0
#define TID_MAXBARKS 26.0
#define TID_MAXMELS 3962.0
#define TID_MAXBARKFREQ 22855.4
#define TID_MAXMELFREQ 22843.6
#define TID_WINDOWSIZEDEFAULT 1024
#define TID_MINWINDOWSIZE 4
#define TID_SAMPLERATEDEFAULT 44100
#define TID_MINSAMPLERATE 64
#define TID_BLOCKSIZEDEFAULT 64
#define TID_NUMWEIGHTPOINTS 29
#define TID_MAXTEXTSTRING 100000
#define TID_PBINRANGEBUFSIZE 64
...
#define TID_BARKSPECBRIGHTNESS_DEFAULTBOUND 8.5
#define TID_ENERGYENTROPY_SUBWINDOWSPERMIDWINDOWDEFAULT 16
#define TID_ENERGYENTROPY_MINSUBWINDOWSPERMIDWINDOW 2
#define TID_SPECBRIGHTNESS_DEFAULTBOUND 1200.0
#define TID_SPECIRREGULARITY_DEFAULTALGO jensen
#define TID_SPECROLLOFF_DEFAULTCONCENTRATION 0.85
