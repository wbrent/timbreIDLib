...
static void* barkSpecIrregularity_tilde_new (t_symbol* s, int argc, t_atom* argv)
{
    ...
    switch (argc)
    {
        ...
        default:
            post ("%s WARNING: Too many arguments supplied. Using default window size of %i, Bark spacing of %f, and the Jensen algorithm.", x->x_objSymbol->s_name, TID_WINDOWSIZEDEFAULT, TID_BARKSPACINGDEFAULT);
            x->x_window = TID_WINDOWSIZEDEFAULT;
            x->x_barkSpacing = TID_BARKSPACINGDEFAULT;
            x->x_algorithm = TID_SPECIRREGULARITY_DEFAULTALGO;
            break;
...
static t_int* barkSpecIrregularity_tilde_perform (t_int* w)
{
    t_uShortInt n;
    t_sampIdx i;
...
{
    barkSpecIrregularity_tilde_class =
    class_new (
        gensym ("barkSpecIrregularity~"),
        (t_newmethod)barkSpecIrregularity_tilde_new,
        (t_method)barkSpecIrregularity_tilde_free,
        sizeof (t_barkSpecIrregularity_tilde),
        CLASS_DEFAULT,
        A_GIMME,
        0
    );
    ...
    CLASS_MAINSIGNALIN (barkSpecIrregularity_tilde_class, t_barkSpecIrregularity_tilde, x_f);

    class_addbang (barkSpecIrregularity_tilde_class, barkSpecIrregularity_tilde_bang);

    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_print,
        gensym ("print"),
        0
    );
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_createFilterbank,
        gensym ("filterbank"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_window,
        gensym ("window"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_overlap,
        gensym ("overlap"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_windowFunction,
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_normalize,
        gensym ("normalize"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_powerSpectrum,
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_algorithm,
        gensym ("algorithm"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_dsp,
        gensym ("dsp"),
        0
    );
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_spec_band_avg,
    ...
    class_addmethod (
        barkSpecIrregularity_tilde_class,
        (t_method)barkSpecIrregularity_tilde_filter_avg,
        gensym ("filter_avg"),
        A_DEFFLOAT,
        0
    );
