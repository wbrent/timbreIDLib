...
static void barkSpecSlope_analyze(t_barkSpecSlope *x, t_floatarg start, t_floatarg n)
{
    ...
    else
    {
        ...
        if(x->x_window != window)
            barkSpecSlope_resizeWindow(x, x->x_window, window, startSamp, &endSamp);
...
static void barkSpecSlope_bang(t_barkSpecSlope *x)
{
    ...
    else
    {
        ...
        barkSpecSlope_analyze(x, startSamp, window);
    }
}
    ...
    switch(argc)
    {
        ...
        default:
            ...
            if(!(a = (t_garray *)pd_findbyclass(x->x_arrayName, garray_class)))
                ...
                pd_error(x, "%s: bad template for %s", x->x_arrayName->s_name, x->x_objSymbol->s_name);
            */
            post("%s WARNING: Too many arguments supplied. Using default Bark spacing of %0.2f.", x->x_objSymbol->s_name, TID_BARKSPACINGDEFAULT);
            x->x_barkSpacing = TID_BARKSPACINGDEFAULT;
            break;
    }
...
void barkSpecSlope_setup(void)
{
    ...
    class_new(
        ...
        (t_newmethod)barkSpecSlope_new,
        (t_method)barkSpecSlope_free,
        sizeof(t_barkSpecSlope),
        CLASS_DEFAULT,
        A_GIMME,
        0
    );
    ...
    class_addbang(barkSpecSlope_class, barkSpecSlope_bang);

    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_analyze,
        gensym("analyze"),
        A_DEFFLOAT,
        A_DEFFLOAT,
        0
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_chain_fftData,
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_chain_magSpec,
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_chain_barkSpec,
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_samplerate,
        gensym("samplerate"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_windowFunction,
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_powerSpectrum,
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_normalize,
        gensym("normalize"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_createFilterbank,
        gensym("filterbank"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_spec_band_avg,
    ...
    class_addmethod(
        barkSpecSlope_class,
        (t_method)barkSpecSlope_filter_avg,
        gensym("filter_avg"),
        A_DEFFLOAT,
        0
    );
