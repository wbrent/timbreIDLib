...
void barkSpecKurtosis_setup(void)
{
    ...
    class_addmethod(
        barkSpecKurtosis_class,
        (t_method)barkSpecKurtosis_chain_fftData,
    ...
    class_addmethod(
        barkSpecKurtosis_class,
        (t_method)barkSpecKurtosis_chain_magSpec,
    ...
    class_addmethod(
        barkSpecKurtosis_class,
        (t_method)barkSpecKurtosis_chain_barkSpec,
    ...
    class_addmethod(
        barkSpecKurtosis_class,
        (t_method)barkSpecKurtosis_window,
        gensym("window"),
        A_DEFFLOAT,
        0
    );
