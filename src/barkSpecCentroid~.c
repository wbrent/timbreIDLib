...
{
    barkSpecCentroid_tilde_class =
    class_new(
        gensym("barkSpecCentroid~"),
        (t_newmethod)barkSpecCentroid_tilde_new,
        (t_method)barkSpecCentroid_tilde_free,
        sizeof(t_barkSpecCentroid_tilde),
        CLASS_DEFAULT,
        A_GIMME,
        0
    );
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_print,
        gensym("print"),
        0
    );
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_createFilterbank,
        gensym("filterbank"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_window,
        gensym("window"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_overlap,
        gensym("overlap"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_windowFunction,
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_powerSpectrum,
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_dsp,
        gensym("dsp"),
        0
    );
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_spec_band_avg,
    ...
    class_addmethod(
        barkSpecCentroid_tilde_class,
        (t_method)barkSpecCentroid_tilde_filter_avg,
        gensym("filter_avg"),
        A_DEFFLOAT,
        0
    );
