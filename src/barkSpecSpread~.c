...
static t_class *barkSpecSpread_tilde_class;

typedef struct _barkSpecSpread_tilde
{
	t_object x_obj;
...
static void barkSpecSpread_tilde_createFilterbank(t_barkSpecSpread_tilde *x, t_floatarg bs)
{
...
static void barkSpecSpread_tilde_spec_band_avg(t_barkSpecSpread_tilde *x, t_floatarg avg)
{
    avg = (avg<0)?0:avg;
    avg = (avg>1)?1:avg;
	x->x_specBandAvg = avg;
...
static void barkSpecSpread_tilde_filter_avg(t_barkSpecSpread_tilde *x, t_floatarg avg)
{
    avg = (avg<0)?0:avg;
    avg = (avg>1)?1:avg;
	x->x_filterAvg = avg;
...
static void barkSpecSpread_tilde_print(t_barkSpecSpread_tilde *x)
{
...
static void barkSpecSpread_tilde_window(t_barkSpecSpread_tilde *x, t_floatarg w)
{
...
static void barkSpecSpread_tilde_overlap(t_barkSpecSpread_tilde *x, t_floatarg o)
{
...
static void barkSpecSpread_tilde_windowFunction(t_barkSpecSpread_tilde *x, t_floatarg f)
{
    f = (f<0)?0:f;
    f = (f>4)?4:f;
...
static void barkSpecSpread_tilde_powerSpectrum(t_barkSpecSpread_tilde *x, t_floatarg power)
{
...
static void *barkSpecSpread_tilde_new(t_symbol *s, int argc, t_atom *argv)
{
	t_barkSpecSpread_tilde *x = (t_barkSpecSpread_tilde *)pd_new(barkSpecSpread_tilde_class);
	t_sampIdx i;
...
static t_int *barkSpecSpread_tilde_perform(t_int *w)
{
	t_uShortInt n;
	t_sampIdx i;

	t_barkSpecSpread_tilde *x = (t_barkSpecSpread_tilde *)(w[1]);
...
static void barkSpecSpread_tilde_dsp(t_barkSpecSpread_tilde *x, t_signal **sp)
{
	dsp_add(
		barkSpecSpread_tilde_perform,
		3,
		x,
		sp[0]->s_vec,
		sp[0]->s_n
...
static void barkSpecSpread_tilde_free(t_barkSpecSpread_tilde *x)
{
	t_filterIdx i;
...
{
	barkSpecSpread_tilde_class =
	class_new(
		gensym("barkSpecSpread~"),
		(t_newmethod)barkSpecSpread_tilde_new,
		(t_method)barkSpecSpread_tilde_free,
		sizeof(t_barkSpecSpread_tilde),
		CLASS_DEFAULT,
		A_GIMME,
		0
	);
	...
	CLASS_MAINSIGNALIN(barkSpecSpread_tilde_class, t_barkSpecSpread_tilde, x_f);

	class_addbang(barkSpecSpread_tilde_class, barkSpecSpread_tilde_bang);

	class_addmethod(
		barkSpecSpread_tilde_class,
		(t_method)barkSpecSpread_tilde_print,
		gensym("print"),
		0
	);
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
		(t_method)barkSpecSpread_tilde_createFilterbank,
		gensym("filterbank"),
		A_DEFFLOAT,
		0
	);
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
		(t_method)barkSpecSpread_tilde_window,
		gensym("window"),
		A_DEFFLOAT,
		0
	);
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
        (t_method)barkSpecSpread_tilde_overlap,
		gensym("overlap"),
		A_DEFFLOAT,
		0
	);
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
		(t_method)barkSpecSpread_tilde_windowFunction,
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
		(t_method)barkSpecSpread_tilde_powerSpectrum,
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
		(t_method)barkSpecSpread_tilde_dsp,
		gensym("dsp"),
		0
	);
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
        (t_method)barkSpecSpread_tilde_spec_band_avg,
	...
	class_addmethod(
		barkSpecSpread_tilde_class,
        (t_method)barkSpecSpread_tilde_filter_avg,
		gensym("filter_avg"),
		A_DEFFLOAT,
		0
	);
