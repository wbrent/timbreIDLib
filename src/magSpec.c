...
static void magSpec_analyze(t_magSpec *x, t_floatarg start, t_floatarg n)
{
    ...
    else
    {
        ...
        if(x->x_window != window)
            magSpec_resizeWindow(x, x->x_window, window, startSamp, &endSamp);
...
static void magSpec_bang(t_magSpec *x)
{
    ...
    else
    {
        ...
        magSpec_analyze(x, startSamp, window);
    }
}
...
void magSpec_setup(void)
{
    ...
    class_addmethod(
        magSpec_class,
        (t_method)magSpec_chain_fftData,
    ...
    class_addmethod(
        magSpec_class,
        (t_method)magSpec_windowFunction,
    ...
    class_addmethod(
        magSpec_class,
        (t_method)magSpec_powerSpectrum,
