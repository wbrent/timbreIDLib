...
static t_class* minSample_tilde_class;

typedef struct _minSample_tilde
{
    t_object x_obj;
...
static void minSample_tilde_bang (t_minSample_tilde* x)
{
...
static void minSample_tilde_window (t_minSample_tilde* x, t_floatarg w)
{
    t_sampIdx i, window;
...
static void minSample_tilde_overlap (t_minSample_tilde* x, t_floatarg o)
{
...
static void minSample_tilde_print (t_minSample_tilde* x)
{
...
static void* minSample_tilde_new (t_symbol* s, int argc, t_atom* argv)
{
    t_minSample_tilde* x = (t_minSample_tilde *)pd_new (minSample_tilde_class);
    t_sampIdx i;
...
static t_int* minSample_tilde_perform (t_int* w)
{
    ...
    t_minSample_tilde* x = (t_minSample_tilde *)(w[1]);
...
static void minSample_tilde_free (t_minSample_tilde* x)
{
...
{
    minSample_tilde_class =
    class_new (
        gensym ("minSample~"),
        (t_newmethod)minSample_tilde_new,
        (t_method)minSample_tilde_free,
        sizeof (t_minSample_tilde),
        CLASS_DEFAULT,
        A_GIMME,
        0
    );
    ...
    CLASS_MAINSIGNALIN (minSample_tilde_class, t_minSample_tilde, x_f);

    class_addbang (minSample_tilde_class, minSample_tilde_bang);

    class_addmethod (
        minSample_tilde_class,
        (t_method)minSample_tilde_print,
        gensym ("print"),
        0
    );
    ...
    class_addmethod (
        minSample_tilde_class,
        (t_method)minSample_tilde_window,
        gensym ("window"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        minSample_tilde_class,
        (t_method)minSample_tilde_overlap,
        gensym ("overlap"),
        A_DEFFLOAT,
        0
    );
