...
static void barkSpecBrightness_analyze(t_barkSpecBrightness *x, t_floatarg start, t_floatarg n)
{
    ...
    else
    {
        ...
        if(x->x_window != window)
            barkSpecBrightness_resizeWindow(x, x->x_window, window, startSamp, &endSamp);
...
static void barkSpecBrightness_bang(t_barkSpecBrightness *x)
{
    ...
    else
    {
        ...
        barkSpecBrightness_analyze(x, startSamp, window);
    }
}
...
{
    barkSpecBrightness_class =
    class_new(
        gensym("barkSpecBrightness"),
        (t_newmethod)barkSpecBrightness_new,
        (t_method)barkSpecBrightness_free,
        sizeof(t_barkSpecBrightness),
        CLASS_DEFAULT,
        A_GIMME,
        0
    );
    ...
    class_addbang(barkSpecBrightness_class, barkSpecBrightness_bang);

    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_analyze,
        gensym("analyze"),
        A_DEFFLOAT,
        A_DEFFLOAT,
        0
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_chain_fftData,
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_chain_magSpec,
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_chain_barkSpec,
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_boundary,
        gensym("boundary"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_set,
        gensym("set"),
        A_SYMBOL,
        0
    );
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_print,
        gensym("print"),
        0
    );
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_samplerate,
        gensym("samplerate"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_window,
        gensym("window"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_windowFunction,
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_powerSpectrum,
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_createFilterbank,
        gensym("filterbank"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_spec_band_avg,
    ...
    class_addmethod(
        barkSpecBrightness_class,
        (t_method)barkSpecBrightness_filter_avg,
        gensym("filter_avg"),
        A_DEFFLOAT,
        0
    );
