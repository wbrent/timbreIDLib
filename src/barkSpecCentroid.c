...
static void barkSpecCentroid_analyze (t_barkSpecCentroid *x, t_floatarg start, t_floatarg n)
{
    ...
    else
    {
        ...
        if (x->x_window != window)
            barkSpecCentroid_resizeWindow (x, x->x_window, window, startSamp, &endSamp);
...
static void barkSpecCentroid_bang (t_barkSpecCentroid *x)
{
    ...
    else
    {
        ...
        barkSpecCentroid_analyze (x, startSamp, window);
    }
}
...
{
    barkSpecCentroid_class =
    class_new (
        gensym ("barkSpecCentroid"),
        (t_newmethod)barkSpecCentroid_new,
        (t_method)barkSpecCentroid_free,
        sizeof (t_barkSpecCentroid),
        CLASS_DEFAULT,
        A_GIMME,
        0
    );
    ...
    class_addbang (barkSpecCentroid_class, barkSpecCentroid_bang);

    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_analyze,
        gensym ("analyze"),
        A_DEFFLOAT,
        A_DEFFLOAT,
        0
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_chain_fftData,
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_chain_magSpec,
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_chain_barkSpec,
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_print,
        gensym ("print"),
        0
    );
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_samplerate,
        gensym ("samplerate"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_window,
        gensym ("window"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_windowFunction,
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_powerSpectrum,
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_createFilterbank,
        gensym ("filterbank"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_spec_band_avg,
    ...
    class_addmethod (
        barkSpecCentroid_class,
        (t_method)barkSpecCentroid_filter_avg,
        gensym ("filter_avg"),
        A_DEFFLOAT,
        0
    );
