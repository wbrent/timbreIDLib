...
static t_int *specSkewness_tilde_perform(t_int *w)
{
    t_uShortInt n;
    t_sampIdx i;
...
{
    specSkewness_tilde_class =
    class_new(
        gensym("specSkewness~"),
        (t_newmethod)specSkewness_tilde_new,
        (t_method)specSkewness_tilde_free,
        sizeof(t_specSkewness_tilde),
        CLASS_DEFAULT,
        A_GIMME,
        0
    );
    ...
    class_addcreator(
        (t_newmethod)specSkewness_tilde_new,
        gensym("timbreIDLib/specSkewness~"),
        A_GIMME,
        0
    );

    CLASS_MAINSIGNALIN(specSkewness_tilde_class, t_specSkewness_tilde, x_f);

    class_addbang(specSkewness_tilde_class, specSkewness_tilde_bang);

    class_addmethod(
        specSkewness_tilde_class,
        (t_method)specSkewness_tilde_print,
        gensym("print"),
        0
    );
    ...
    class_addmethod(
        specSkewness_tilde_class,
        (t_method)specSkewness_tilde_window,
        gensym("window"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        specSkewness_tilde_class,
        (t_method)specSkewness_tilde_overlap,
        gensym("overlap"),
        A_DEFFLOAT,
        0
    );
    ...
    class_addmethod(
        specSkewness_tilde_class,
        (t_method)specSkewness_tilde_windowFunction,
    ...
    class_addmethod(
        specSkewness_tilde_class,
        (t_method)specSkewness_tilde_powerSpectrum,
    ...
    class_addmethod(
        specSkewness_tilde_class,
        (t_method)specSkewness_tilde_dsp,
        gensym("dsp"),
        0
    );
}
